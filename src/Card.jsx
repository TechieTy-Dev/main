...
const Card = () => {
  return (
    <div className='w-100 h-100 lg:w-[60%] lg:flex lg:flex-row lg:mx-auto lg:mt-40 lg:shadow-lg lg:rounded-2xl'>
  ...
  {/* CARD BTM */}
  <div className="w-[80%] mx-auto pt-2 pb-4 lg:w-[60%] lg:p-8 lg:rounded-br-lg">
 <h3 className='gray mt-4 font-extrabold lg:text-xl'>Summary</h3>
 {/* REACTION CARD */}
 <div className='flex justify-between red-bg w-100 p-4 mt-4 mb-3 rounded-lg'>
 ...
 <h4 className='red font-semibold'> Reaction </h4>
  ...
  {/* MEMORY CARD */}
  <div className='flex justify-between orange-bg w-100 p-4 mt-4 mb-3 rounded-lg'>
    <div className='flex align-middle justify-center gap-4'>
...
{/* VERBAL CARD */}
<div className='flex justify-between green-bg w-100 p-4 mt-4 mb-3 rounded-lg'>
    <div className='flex align-middle justify-center gap-4'>
 ...
 <h4 className='green font-semibold'>Verbal</h4>
  ...
  {/* Visual Card */}
  <div className='flex justify-between blue-bg w-100 p-4 mt-4 mb-3 rounded-lg'>
    <div className='flex align-middle justify-center gap-4'>
 ...
 <button className="gray-bg w-[100%] p-4 h-[60px] text-white font-semibold rounded-full text-center mt-3  hover:bg-[#1125d4] hover:cursor-pointer">Continue</button> 
 </div>
    </div>
  )
}
